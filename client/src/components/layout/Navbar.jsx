        ...
        <>
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 border border-slate-200 rounded-lg text-xs text-slate-500 hover:bg-red-50 hover:text-red-600 hover:border-red-100 transition duration-150 cursor-pointer font-medium"
              title="Sign Out"
            >
          ...
          {/* Mobile View (screens < 640px) - User Avatar Toggle */}
